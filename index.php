  ...
  <section class="login-box">
    ...
    <div class="login-box-body" ng-controller="LoginController">
      <p class="login-box-msg">
        <strong><?php echo trans('text_ingresar'); ?></strong>
      </p>
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="carlos@hotmail.com" placeholder="Email / Phone No." name="username">
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="password" class="form-control" value="123" placeholder="Password" name="password">
          </div>
        </div>

        <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat" data-loading-text="Logging...">
          <i class="fa fa-fw fa-sign-in"></i> 
          <?php echo trans('button_iniciar_'); ?>
        </button>
      </form>
      <?php if(DEMO) : ?>
      <div id="credentials">
        ...
        <div>
          ...
          <p class="text-center">
            <a href="#forgotPasswordModal" data-toggle="modal" data-target="#forgotPasswordModal" title="<?php echo trans('text_forgot_password'); ?>" class="text-danger">
              <?php echo trans('text_Recuperar_Contraseña'); ?>
            </a>
          </p>
        </div>
      <?php endif; ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="">Derechos Reservados Carlos Prieto</a> </p>
    </div>
  </section>
